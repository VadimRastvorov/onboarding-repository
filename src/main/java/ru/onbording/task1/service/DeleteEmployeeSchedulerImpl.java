...
@Service
public class DeleteEmployeeSchedulerImpl implements DeleteEmployeeScheduler {
    private static final Logger log = LoggerFactory.getLogger(DeleteEmployeeSchedulerImpl.class);
